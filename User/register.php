      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-0 mb-lg-0">
          ...
          <li class="nav-item navItemUser" style="display: flex;align-items:center;">
            <a class="nav-link" href="register.php" tabindex="-1" aria-disabled="true">
              <img src="../Vector/account_circle-white-48dp.svg" class="img" alt="">
              <span style="padding-top:200px;">User</span>
            </a>
          </li>
        </ul>
      </div>
  ...
  <main>
    <div class="isiform">
      <div class="gambarForm" style="float:left;margin:60px 60px 0px 3vw;">
        <img class="gameBannerImg" style="margin-left:60px;" src="../Img/home/Mv.png" alt="">
        <h1>Already have an account?</h1>
        <a href="login.php"><button class="button" type="button" name="button" style="margin-left:107px;">LOGIN HERE</button></a>
      </div>
      <form style="float:left;" action="checkRegister.php" method="post">
        ...
        <input class="inputText" type="password" id="" name="confirmPassword" required value="">
        <br>
        <br>
