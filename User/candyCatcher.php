...
<body id="body" class="bodyCandy" style="">
  ...
  <p></p>
  <main>
    <div class="container-fluid frontBannerCandy">
      <h1 class="frontBannerText" style="left:115px;font-family:CANDY, sans-serif;font-size:7rem">CANDY CATCHER</h1>
      <img class="frontBannerImg" src="../Img/unity/unity.png" alt="">
    </div>
    ...
    <div class="container mt-5">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" id="carouselExampleIndicators1">
          <img class="d-block w-100  previewBannerCandy" src="../Img/unity/r1.png" alt="First slide">
          <div class="carousel-caption d-none d-md-block">
            <h1 class="previewBannerText">BEST UNITY GAMES</h5>
          </div>
        </div>
        <div class="carousel-item active" id="carouselExampleIndicators2">
          <img class="d-block w-100  previewBannerCandy" src="../Img/unity/r2.png" alt="Second slide">
          <div class="carousel-caption d-none d-md-block">
            <h1 class="previewBannerText">BEST UNITY GAMES</h5>
          </div>
        </div>
    ...
    <div class="container downloadBannerCandy mt-5">
      ...
      <div class="isiUpdate">
        <table class="tableUpdate">
          ...
          if ($result -> num_rows > 0) {
              ...
              <tr>
                <td style="width:25%">
                  <a href="downloadCandy.php?data=<?php echo $row['Id']; ?>" >Download</a>
                </td>
                <td style="width:75%">
...
<audio src="../music/home/Ship1.mp3" autoplay loop>
</html>
