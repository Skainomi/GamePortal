...
<body id="body">
  ...
  <main>
    <div class="isiform">
      <h1 class="textRegister" style="">Change Data</h1>
      <form style="margin-left:90px;" action="checkChangeData.php" method="post">

        <label for="">Email : </label><br>
        <input class="inputText" type="text" id="" name="email" value="<?php echo $email; ?>">
        <br>
        <br>
        <input class="inputText" type="hidden" id="" name="username" value="<?php echo $username; ?>">
        <label for="">Password :</label><br>
        <input class="inputText" type="password" id="" name="password" value="">
        <br>
        <br>
        <label for="">Confirm Password :</label><br>
        <input class="inputText" type="password" id="" name="confirmPassword" value="">
        <br>
        <br>
        <label for="">Phone Number :</label><br>
        <input class="inputText" type="number" id="" name="phoneNumber" value="<?php echo $number; ?>">
        <br>
